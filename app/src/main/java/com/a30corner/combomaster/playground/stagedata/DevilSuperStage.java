...
public class DevilSuperStage extends IStage {
    ...
    public void create(IEnvironment env,
        ...
        {
            data.add(Enemy.create(env, 1062, 3540047, 38066, 0, 2,
        ...
        data = new ArrayList<Enemy>();
        {
            ...
            if(choose == 895) {
                data.add(Enemy.create(env, choose, 3538162, 17714, 3280, 1,
                ...
                data.add(Enemy.create(env, choose, 77782, 5500, 1500000, 1,
                ...
                data.add(Enemy.create(env, choose, 3248782, 34061, 0, 2,
                ...
                data.add(Enemy.create(env, choose, 1788338, 29468, 544, 1,
                        new Pair<Integer, Integer>(0, -1),
                        getMonsterTypes(env, choose)));
                zero = data.get(0);
                zero.attackMode = new EnemyAttackMode();
        ...
        data = new ArrayList<Enemy>();
        {
            data.add(Enemy.create(env, 1510, 6784522, 26454, 4690, 1,
        ...
        data = new ArrayList<Enemy>();
        {
            data.add(Enemy.create(env, 647, 10696241, 10164, 804, 1,
        ...
        data = new ArrayList<Enemy>();
        {
            data.add(Enemy.create(env, 1371, 7802307, 29829, 5460, 1,
                    new Pair<Integer, Integer>(0, -1),
        ...
        data = new ArrayList<Enemy>();
        {
            data.add(Enemy.create(env, 1849, 28197340, 42335, 0, 1,
                    new Pair<Integer, Integer>(0, -1),
            ...
            seq.addAttack(new EnemyAttack().addAction(
                    ...
                    .addPair(
                            new ConditionAlways(),
                            new RandomChange(text[35].title,
                                    text[35].description, 8, 2)));
            zero.attackMode.addAttack(new ConditionFirstStrike(), seq);
            ...
            seq = new SequenceAttack();
            seq.addAttack(new EnemyAttack().addPair(new ConditionAlways(),
                    new Gravity(text[36].title, text[36].description, 99)));
            seq.addAttack(new EnemyAttack().addPair(new ConditionAlways(),
                    new RandomChange(text[37].title, text[37].description, 8,
                            5)));
            seq.addAttack(new EnemyAttack().addPair(new ConditionAlways(),
                    new RandomChange(text[37].title, text[37].description, 8,
                            5)));
            seq.addAttack(new EnemyAttack().addPair(new ConditionAlways(),
                    new RandomChange(text[37].title, text[37].description, 8,
                            5)));
            seq.addAttack(new EnemyAttack().addPair(new ConditionAlways(),
                    new MultipleAttack(text[38].title, text[38].description,
                            1000, 2)));
            zero.attackMode.addAttack(new ConditionHp(1, 0), seq);
        }
        mStageEnemies.put(++stageCounter, data);
