 ...
 * @author vincent
 */
public class PadBoardAI5x4 {
	public static final int COLS = 4;
	public static final int ROWS = 5;
	private static final int TYPES = 6;

	public PadBoardAI5x4() {
		init();
	}
	...
	private static final String[] ORB_ARRAY = { "dark5x4.png", "fire5x4.png",
			"heart5x4.png", "light5x4.png", "water5x4.png", "wood5x4.png", "poison5x4.png",
			"jammar5x4.png" };
	private static final String[] ORB_ARRAY_CW = { "dark_cw5x4.png",
			"fire_cw5x4.png", "heart_cw5x4.png", "light_cw5x4.png", "water_cw5x4.png",
			"wood_cw5x4.png", "poison5x4.png", "jammar5x4.png" };

	private static final String[] TOS_GEM_ARRAY = { "gem_dark5x4.png",
			"gem_fire5x4.png", "gem_heart5x4.png", "gem_light5x4.png", "gem_water5x4.png",
			"gem_wood5x4.png", "poison5x4.png", "jammar5x4.png" };
	...
	public static int[][] randomChangedBoard(int[][] board, Set<Integer> from, List<Integer> to) {
		int[][] newBoard = PadBoardAI5x4.create_empty_board();
		int targetSize = to.size();
		for (int i = 0; i < ROWS; ++i) {
			for (int j = 0; j < COLS; ++j) {
				int orb = board[i][j]%10;
				if(from.contains(orb)) {
					newBoard[i][j] = (int)to.get(RandomUtil.getInt(targetSize));
				} else {
	...
	public static int[][] generateBoard(long type, boolean can3) {
		...
		if (!can3 && type >= 3) {
			...
			do {
				MatchBoard5x4 matchBoard = PadBoardAI5x4.findMatches(board);
	...
	public static MatchBoard5x4 findMatches(final int[][] board) {
		return findMatches(board, 3);
	}
	
	public static MatchBoard5x4 findMatches(final int[][] board, int removeN) {
		...
		ArrayList<Match5x4> matches = new ArrayList<Match5x4>();
		...
		for (int j = 0; j < COLS; ++j) {
			for (int i = 0; i < ROWS; ++i) {
				...
				if(matchList.size()>=removeN) {
					matches.add(Match5x4.make(current, count, pcount, matchList));
				} else {
		...
		return new MatchBoard5x4(match_board, matches);
	}
