 ...
 * @author vincent
 */
public class PadBoardAI7x6 {
	public static final int COLS = 6;
	public static final int ROWS = 7;
	private static final int TYPES = 6;

	public PadBoardAI7x6() {
		init();
	}
	...
	private static final String[] ORB_ARRAY = { "dark7x6.png", "fire7x6.png",
			"heart7x6.png", "light7x6.png", "water7x6.png", "wood7x6.png", "poison7x6.png",
			"jammar7x6.png" };
	private static final String[] ORB_ARRAY_CW = { "dark_cw7x6.png",
			"fire_cw7x6.png", "heart_cw7x6.png", "light_cw7x6.png", "water_cw7x6.png",
			"wood_cw7x6.png", "poison7x6.png", "jammar7x6.png" };

	private static final String[] TOS_GEM_ARRAY = { "gem_dark7x6.png",
			"gem_fire7x6.png", "gem_heart7x6.png", "gem_light7x6.png", "gem_water7x6.png",
			"gem_wood7x6.png", "poison7x6.png", "jammar7x6.png" };
	...
	public static int[][] randomChangedBoard(int[][] board, Set<Integer> from, List<Integer> to) {
		int[][] newBoard = PadBoardAI7x6.create_empty_board();
	...
	public static int[][] generateBoard(long type, boolean can3) {
		...
		if (!can3 && type >= 3) {
			...
			do {
				MatchBoard7x6 matchBoard = PadBoardAI7x6.findMatches(board);
	...
	public static MatchBoard7x6 findMatches(final int[][] board) {
		return findMatches(board, 3, null);
	}
	
	public static MatchBoard7x6 findMatches(final int[][] board, int removeN, List<Integer> cantRemove) {
		...
		ArrayList<Match7x6> matches = new ArrayList<Match7x6>();
		...
		for (int j = 0; j < COLS; ++j) {
			for (int i = 0; i < ROWS; ++i) {
				...
				if(matchList.size()>=removeN && !cantRemoveSet.contains(current)) {
					matches.add(Match7x6.make(current, count, pcount, matchList));
				} else {
		...
		return new MatchBoard7x6(match_board, matches);
	}
