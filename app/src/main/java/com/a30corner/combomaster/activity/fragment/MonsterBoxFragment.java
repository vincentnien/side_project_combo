...
public class MonsterBoxFragment extends CMBaseFragment {
							...
							public boolean onLongClick(View v) {
								...
								.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
								    ...
								    public void onClick(DialogInterface dialog, int whichButton) {
								    	LocalDBHelper.removeMonsterFromBox(getActivity(), data.getIndex());
								    	reloadMonsterBox();
								    }})
    ...
    private void sort(List<MonsterInfo> list, Map<String, String> data) {
        ...
        if ( data == null ) {
            ...
            SharedPreferences pref = getActivity().getSharedPreferences(BOX_SORT_PREF, Context.MODE_PRIVATE);
            for(int i=0; i<5; ++i) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		btnSort.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                SortDialog dialog = DialogUtil.getSortDialog(activity, BOX_SORT_PREF, new ISortCallback() {
